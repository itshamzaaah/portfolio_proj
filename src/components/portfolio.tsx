...
const projects: Project[] = [
  {
    ...
    title: "ArabiaWheel",
    category: "app",
    image: "https://drive.google.com/uc?id=1w8PL8igiHduReKcfd9vHy3A_28OCdBkm",
    description:
      "The ArabiaWheel Project is an automotive management platform for vehicle sales, bidding, and showroom operations. It allows users to bid on vehicles, manage vehicle listings, and interact with multiple showrooms. The platform features detailed vehicle specifications, real-time updates, and advanced search filters.",
    technologies: [
  ...
  title: "PairfectAI",
  category: "web",
  image: "https://drive.google.com/uc?id=1vQQuPqHC5yVcINUPGWJGl3KaYYukm5vO",
  description:
    "An AI-powered platform that connects founders, freelancers, entrepreneurs, and investors with ideal business partners. It uses smart matching based on skills, goals, industries, values, and work styles. Think LinkedIn meets a dating app — for starting and scaling ventures. Features include personality tests, match scores, in-app chat, and global support. Ideal for finding co-founders, collaborators, or investors across borders.",
  technologies: [
    { tech: "React.js", skill: "Frontend" },
    { tech: "Javascript", skill: "Frontend" },
    { tech: "Spring Boot 3", skill: "Backend" },
    { tech: "AI (Decision Tree, Cosine Similarity)", skill: "Backend" },
    { tech: "MySQL", skill: "Payment Gateway" },
    { tech: "GitHub", skill: "Payment Gateway" },
  ],
},
];
...
export function Portfolio() {
  ...
  return (
    <section id="portfolio" className="py-20 bg-gray-50 h-[200vh] sm:h-[120vh]">
