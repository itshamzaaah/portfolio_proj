...
const DevOpsSkills = [
  ...
  { name: "Azure Factory", level: "Intermediate" },
...
const SoftSkills = [
  ...
  { name: "Problem-solving and debugging", level: "Intermediate" },
  { name: "Time management", level: "Intermediate" },
  { name: "Effective Communication", level: "Intermediate" },
  { name: "Mentoring and Knowledge Sharing", level: "Intermediate" },
];
    ...
    <section id="skills" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 overflow-x-hidden pb-12 rounded-2xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 gap-8 text-black md:px-8">
          ...
          {/* Soft & Methologies  Skills Card */}
          <motion.div
            className="bg-white p-6 rounded-2xl shadow-lg overflow-hidden"
            initial="hidden"
            whileInView="visible"
            exit="exit"
            variants={SoftAnimation}
            transition={{ duration: 0.8, ease: "easeInOut" }}
            viewport={{ once: false, amount: 0.5 }}
          >
            <h3 className="text-xl font-bold mb-4">Soft Skills & Methodologies</h3>
            <div className="grid grid-cols-2 gap-4">
